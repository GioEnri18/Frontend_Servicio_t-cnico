          ...
          <>
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Empleados</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Técnicos</div>
              </div>
            </div>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                      <tr style={{ backgroundColor: '#f3f4f6' }}>
                        ...
                        <th style={{ padding: '0.75rem', textAlign: 'center', fontWeight: '600', color: '#374151' }}>Estado</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr key={employee.id} style={{ 
                          ...
                          <td style={{ padding: '0.75rem', textAlign: 'center' }}>
                            <span style={{
                              ...
                              color: employee.status === 'active' ? '#065f46' : '#dc2626'
                            }}>
